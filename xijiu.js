...
环境变量：XiJiu
格式：[{"id": "xxxxxxxc5d1fa46", "token": "xxxxxxUzI1NiJ9.eyJtZW1iZXJJbmZvIjp7ImlkIjozMTMyMzY4fSwiZXhwaXJlVGltZSI6MTcxNTc2MjI2NX0.DkFcIInFSXJesM4y5_VNgNFBzR7FrlTks4oJisgjcX4"}]
token值抓任意请求头 Authorization 值, id 值取 X-Trace-id 值，抓 /api/open/event-log/ 响应头的 X-Trace-id 或者 resp 的 xid:
每天运行一两次
cron: 33 7,19 * * *
const $ = new Env("习酒");
*/
